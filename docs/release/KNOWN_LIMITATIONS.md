...
- Rules are local literal rules; this is not a full YARA engine implementation.
...
- No action is taken against a target: no deletion, quarantine, remediation, containment, or alert transport.
